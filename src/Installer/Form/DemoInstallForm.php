...
class DemoInstallForm extends FormBase {
  ...
  public function getFormId() {
    return 'apigee_devportal_kickstart_openbank_au_demo_install_form';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    // "drush si apigee_kickstart apigee_devportal_kickstart_openbank_au_demo_install_form.install_demo_content=0".
    ...
    if ($demo_content) {
      $this->moduleInstaller->install(['apigee_kickstart_openbank_au_content']);
